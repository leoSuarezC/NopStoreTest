    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual LogoModel PrepareLogoModel()
        {
            ...
            model.LogoPath = _cacheManager.Get(cacheKey, () =>
            {
                ...
                {
                    //use default logo
                    logo = $"{_webHelper.GetStoreLocation(true)}Themes/{_themeContext.WorkingThemeName}/Content/images/logo.png";
                }
                return logo;
            });
        ...
        public virtual FaviconModel PrepareFaviconModel()
        {
            ...
            model.FaviconUrl = _webHelper.GetStoreLocation(true) + faviconFileName;
            return model;
        }
