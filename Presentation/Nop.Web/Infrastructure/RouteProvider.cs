...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("TrackingProxy",
                "FactFinderSearch/TrackingProxy",
                new { controller = "Catalog", action = "TrackingProxy" });

            routeBuilder.MapLocalizedRoute("HauthalerProduktOberGruppeNameMarke",
                "kategorie/{ProduktOberGruppeName}/marke/{ProduktMarkeName[0]}",
                new { controller = "Catalog", action = "SearchFactFinder" }); // make

            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie5MitMarkeUndPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/{ProduktUnterGruppeKat5}/marke/{ProduktMarkeName[0]}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat5NameMarkeName",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/{ProduktUnterGruppeKat5}/marke/{ProduktMarkeName[0]}/",
                new { controller = "Catalog", action = "SearchFactFinder" });// category1/category2/category3/category4/category5/marke/make
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat5NameKollektionMitPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/{ProduktUnterGruppeKat5}/kollektion/{Schlagworte}/seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat5Name",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/{ProduktUnterGruppeKat5}",
                new { controller = "Catalog", action = "SearchFactFinder" }); // category1/category2/category3/category4/category5


            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie4MitMarkeUndPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/marke/{ProduktMarkeName[0]}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat4NameMarkeName",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/marke/{ProduktMarkeName[0]}/",
                new { controller = "Catalog", action = "SearchFactFinder" }); // category1/category2/category3/category4/marke/make
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat4NameKollektionMitPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}/kollektion/{Schlagworte}/seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeKat4Name",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/{ProduktUnterGruppeKat4}",
                new { controller = "Catalog", action = "SearchFactFinder" }); // category1/category2/category3/category4


            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie3MitMarkeUndPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/marke/{ProduktMarkeName[0]}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeNameMarkeName",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/marke/{ProduktMarkeName[0]}/", // category1/category2/category3/marke/make
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeNameKollektionMitPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}/kollektion/{Schlagworte}/seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktUnterGruppeName",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/{ProduktUnterGruppeName}", // category1/category2/category3
                new { controller = "Catalog", action = "SearchFactFinder" });


            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie2MitMarkeUndPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/marke/{ProduktMarkeName[0]}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" }); 
            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie2MitMarke",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/marke/{ProduktMarkeName[0]}/",  // category1/category2/marke/make
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktGruppeNameKollektionMitPaging",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}/kollektion/{Schlagworte}/seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktGruppeName",
                "kategorie/{ProduktOberGruppeName}/{ProduktGruppeName}",
                new { controller = "Catalog", action = "SearchFactFinder" }); // category1/category2


            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachKategorie1MitPaging",
                "kategorie/{ProduktOberGruppeName}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktOberGruppeName",
                "kategorie/{ProduktOberGruppeName}",
                new { controller = "Catalog", action = "SearchFactFinder" }); //category1


            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheNachProduktmarkeMitPaging",
                "marke/{ProduktMarkeName[0]}/seite-{Seite:int}/",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerKollektionMitPaging",
                "kollektion/{Schlagworte}/seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });

            routeBuilder.MapLocalizedRoute("HauthalerProduktMarke",
                "marke/{ProduktMarkeName[0]}",
                new { controller = "Catalog", action = "SearchFactFinder" }); //marke/make
            routeBuilder.MapLocalizedRoute("HauthalerKollektion",
                "kollektion/{Schlagworte}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktSucheMitPaging",
                "seite-{Seite:int}",
                new { controller = "Catalog", action = "SearchFactFinder" });
            routeBuilder.MapLocalizedRoute("HauthalerProduktAnbieter",
                "Onlineshop",
                new { controller = "Catalog", action = "SearchFactFinder" }); //onlineshop
            //routeBuilder.MapLocalizedRoute("HauthalerProduktAnbieter",
            //   "Onlineshop",
            //   new { controller = "Catalog", action = "SearchFactFinder" });
            //routeBuilder.MapLocalizedRoute("HauthalerProduktGruppeName",
            ...
            //manufacturers
            routeBuilder.MapLocalizedRoute("ManufacturerList", "marken",
