...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult Completed(int? orderId)
        {
            ...
            ViewBag.OrderDetails = _orderModelFactory.PrepareOrderDetailsModel(order);
            return View(model);
        }
        ...
        public virtual IActionResult SelectPaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            ...
            if (paymentmethod.IndexOf("_") > 0) //A.V MPay24 Options
            {
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SystemCustomerAttributeNames.SessionMPay24PaymentOption, paymentmethod.Substring(paymentmethod.IndexOf("_") + 1));                
                paymentmethod = paymentmethod.Substring(0, paymentmethod.IndexOf("_"));
            }
            else
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SystemCustomerAttributeNames.SessionMPay24PaymentOption, _paymentService.LoadPaymentMethodBySystemName(paymentmethod).GetLocalizedFriendlyName(_localizationService, _workContext.WorkingLanguage.Id));
        ...
        public virtual IActionResult PaymentInfo()
        {
            ...
            //Check whether payment info should be skipped A.V added true condtion to skip message from MPay24, assuming only MPay24 type payments supported on site
            if (true || paymentMethod.SkipPaymentInfo || 
            ...
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    ...
                    var postProcessPaymentRequest = new PostProcessPaymentRequest
                    {
                        ...
                        MPay24PaymentOption = _workContext.CurrentCustomer.GetAttribute<string>(SystemCustomerAttributeNames.SessionMPay24PaymentOption) //A.V
                    };
                    postProcessPaymentRequest.MPay24PaymentOption = string.IsNullOrEmpty(postProcessPaymentRequest.MPay24PaymentOption) ? "" : postProcessPaymentRequest.MPay24PaymentOption;//A.V
