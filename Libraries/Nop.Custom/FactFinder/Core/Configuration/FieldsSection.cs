...
namespace Omikron.FactFinder.Core.Configuration
{
    public class FieldsSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("normalPrice", DefaultValue = null, IsRequired = true, IsKey = true)]
        public string NormalPrice
        {
            get
            {
                return (string)this["normalPrice"];
            }
            set
            {
        ...
        [ConfigurationProperty("BildURL", DefaultValue = null, IsRequired = true, IsKey = true)]
        public string BildUrl
        {
            get
            {
                return (string)this["BildURL"];
            }
            set
            {
                this["BildURL"] = value;
        ...
        [ConfigurationProperty("ProduktURL", DefaultValue = null, IsRequired = true, IsKey = true)]
        public string ProductUrl
        {
            get
            {
                return (string)this["ProduktURL"];
            }
            set
            {
                this["ProduktURL"] = value;
            }
        }
        ...
        [ConfigurationProperty("masterProduktID", DefaultValue = null, IsRequired = false, IsKey = true)]
        public string MasterProduktID
        {
            get
            {
                return (string)this["masterProduktID"];
            }
            set
            {
                this["masterProduktID"] = value;
            }
        }
