...
namespace Nop.Plugin.Payments.CashOnDelivery
{
    ...
    public class CashOnDeliveryPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            {
                DescriptionText = "Sie bezahlen an den ausliefernden Paketdienst bei Übergabe Ihrer bestellten Artikel. ACHTUNG: Per Nachnahme versenden wir nur nach Österreich! ATTENTION: We accept \"cash on delivery\" only in Austria!"
            };
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.CashOnDelivery.PaymentMethodDescription", "Sie bezahlen an den ausliefernden Paketdienst bei Übergabe Ihrer bestellten Artikel. ACHTUNG: Per Nachnahme versenden wir nur nach Österreich! ATTENTION: We accept \"cash on delivery\" only in Austria!");
